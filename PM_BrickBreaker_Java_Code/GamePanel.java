...
//    private boolean spcount = false;
//    private Ball spball = null;
    ...
    public GamePanel() {
        ...
        timer = new Timer(1, this); // 1000ms / 1
        timer.start();
            ...
            while (brickIterator.hasNext()) {
                ...
                if (ball.checkBrickCollision(brick)) {
                    ...
                    if (brick.isSpecial()) {
                        ...
                        newBalls.add(new Ball(newBallPosition, 12, newDx, newDy, ball.getMINSPEED()));
                    }
                    if(bricks.isEmpty()) {
                    	// 공 갯수 만큼 점수 추가
                    	score += balls.size() * 100;
                        System.out.println("Game Over!");
                        timer.stop();
                        gameRunning = false; // 게임 종료 상태 설정
                    }
